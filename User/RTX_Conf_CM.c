...
void os_tmr_call (U16 info) {
  ...
  */
  ...
  switch(info)
  {
	...
	case 2:          /* 参数为1 ,按键A*/
      g_tDoorStatus.closeDoor(&g_tParam.relation.relationA, e_BUTTON_A);//e_BUTTON_A和 e_BUTTON_B在closeDoor函数中情况一样，不必区分
      break;
	
	case 3:          /* 参数为2，按键B */
	  g_tDoorStatus.closeDoor(&g_tParam.relation.relationB, e_BUTTON_B);//同上      
      break;
